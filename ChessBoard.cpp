...
bool ChessBoard:: is_row_clear (int src_row, int src_col, int des_row, int des_col){
  ...
  int x,y; //x document the small col number
...
void ChessBoard::submitMove(const char* source, const char* destination){
  ...
  //after print out sentence we need, we can make move here
  ...
  // now_king document it's opponents's king's position
 ...
 *@param src_col: integer of column numbers of the source CHess Piece
 *@param des_col: integer of column numbers of the destiantion Chess Piece
 *@param chess_colour, bool variable to document the colour of the piece of this turn. true stands for white
 ...
 *@param des_row: integer of row numbers of the destiantion Chess Piece.
 *@param des_col: integer of column numbers of the destiantion Chess Piece
 *@param chess_colour: bool variable which stands for the colour of moving piece of the source(or the colour of the piece which its turn now), true stands for white, false stands for black.
